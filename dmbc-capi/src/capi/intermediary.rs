...
ffi_fn! {
    fn dmbc_internediary_create(public_key: *const c_char, commision: u64, error: *mut Error) -> *mut Intermediary {
...
ffi_fn! {
    fn dmbc_internediary_free(intermediary: *const Intermediary) {
